...
Tags			 : breadcrumbs,shortcode,post,category
Stable tag		 : 1.48
...
Show breadcrumbs for posts, pages and categories
...
= Plugin Description =
Show breadcrumbs for posts & categories, with a shortcode `[breadcrumbs]`. You can use that in template files or hooks with plugins.
